...
class MovieControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create movie time' do
    ...
    post create_movie_time_url, params: { movie_time: { movie_id: movie.id, time: '12:00', date_start: '2021-12-12', date_end: '2021-12-12', room: 'A' } }
    assert_response :redirect
  ...
  test 'should notice missing movie' do
    post create_movie_time_url, params: { movie_time: { movie_id: '', time: '12:00', date_start: '2021-12-12', date_end: '2021-12-12', room: 'A' } }
    assert_response :redirect
  ...
  test 'should notice missing date_start' do
    movie = Movie.create(title: 'La ciudad perdida', image: 'https://www.ecartelera.com/carteles/17000/17009/001_p.jpg')
    post create_movie_time_url, params: { movie_time: { movie_id: movie.id, time: '12:00', date_start: '', date_end: '2021-12-12', room: 'A' } }
    assert_equal 'Falta la fecha inicial', flash[:notice]
  end

  test 'should notice missing date_end' do
    movie = Movie.create(title: 'La ciudad perdida', image: 'https://www.ecartelera.com/carteles/17000/17009/001_p.jpg')
    post create_movie_time_url, params: { movie_time: { movie_id: movie.id, time: '12:00', date_start: '2021-12-12', date_end: '', room: 'A' } }
    assert_response :redirect
  ...
  test 'should list by date with params and movie' do
    movie = Movie.create(title: 'La ciudad perdida', image: 'https://www.ecartelera.com/carteles/17000/17009/001_p.jpg')
    MovieTime.create(movie_id: movie.id, time: '12:00', date_start: '2021-12-12', date_end: '2021-12-12', room: 'A')
    get list_by_date_url, params: { date: '2021-12-12' }
    assert_response :success
  end
end
