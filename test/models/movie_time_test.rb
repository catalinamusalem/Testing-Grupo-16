...
class MovieTimeTest < ActiveSupport::TestCase
  ...
  test 'Date start invalid' do
    @movie_time2 = MovieTime.new(time: 'TANDA', date_start: '2022-10-30',
                                 date_end: '2022-10-28', room: '1', movie_id: '1',
                                 sucursal: 'Santiago')
  ...
  test 'Sucursal invalida' do
    @movie_time4 = MovieTime.new(time: 'TANDA', date_start: '2023-10-26',
                                 date_end: '2023-10-28', room: '8', movie_id: '1',
                                 sucursal: 'Concepcion')
    assert_not @movie_time4.valid?
  end

  test 'Sucursal no ingresada' do
    @movie_time4 = MovieTime.new(time: 'TANDA', date_start: '2023-10-26',
                                 date_end: '2023-10-28', room: '8', movie_id: '1', sucursal: '')
    assert_not @movie_time4.valid?
  end

  test 'room already in use' do
    movie1 = Movie.create(title: 'Movie1', edad: '20', idioma: 'Inglés')
    movie2 = Movie.create(title: 'Movie2', edad: '20', idioma: 'Inglés')
